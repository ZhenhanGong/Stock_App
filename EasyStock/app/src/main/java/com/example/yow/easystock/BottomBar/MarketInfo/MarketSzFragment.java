 ...
 */
public class MarketSzFragment extends Fragment {
    ...
    ListView listView;
    MarketSzAdapter adapter;
    ArrayList<MarketSzItem> array;
    SwipeRefreshLayout mSwipeRefreshLayout;

    public static MarketSzFragment newInstance() {

        Bundle args = new Bundle();

        MarketSzFragment fragment = new MarketSzFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        array = new ArrayList<MarketSzItem>();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_market_sz, container, false);
        return rootView;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        listView = (ListView)getParentFragment().getActivity().findViewById(R.id.list_sz);
        adapter = new MarketSzAdapter(getParentFragment().getContext(),array);
        listView.setAdapter(adapter);

        mSwipeRefreshLayout = (SwipeRefreshLayout)getParentFragment().getActivity().findViewById(R.id.swipe_refresh_layout2);
    }
    ...
    private void FindViewById(){
        ...
        text1 = (TextView)getParentFragment().getActivity().findViewById(R.id.sz_name1);
        text2 = (TextView)getParentFragment().getActivity().findViewById(R.id.sz_price1);
        text3 = (TextView)getParentFragment().getActivity().findViewById(R.id.sz_offset1);
        text4 = (TextView)getParentFragment().getActivity().findViewById(R.id.sz_percent1);
        text5 = (TextView)getParentFragment().getActivity().findViewById(R.id.sz_name2);
        text6 = (TextView)getParentFragment().getActivity().findViewById(R.id.sz_price2);
        text7 = (TextView)getParentFragment().getActivity().findViewById(R.id.sz_offset2);
        text8 = (TextView)getParentFragment().getActivity().findViewById(R.id.sz_percent2);
        text9 = (TextView)getParentFragment().getActivity().findViewById(R.id.sz_name3);
        text10 = (TextView)getParentFragment().getActivity().findViewById(R.id.sz_price3);
        text11 = (TextView)getParentFragment().getActivity().findViewById(R.id.sz_offset3);
        text12 = (TextView)getParentFragment().getActivity().findViewById(R.id.sz_percent3);
        layout1 = (LinearLayout) getParentFragment().getActivity().findViewById(R.id.sz_square1);
        layout2 = (LinearLayout) getParentFragment().getActivity().findViewById(R.id.sz_square2);
        layout3 = (LinearLayout) getParentFragment().getActivity().findViewById(R.id.sz_square3);
        ...
        handler = new Handler(){
            ...
            public void handleMessage(Message msg) {
                ...
                for(int i = 0; i < 15; i++){
                    ...
                    MarketSzItem item = new MarketSzItem(temp[i*4+12],temp[i*4+13],temp[i*4+14],temp[i*4+15]);
                    adapter.add(item);
                }
