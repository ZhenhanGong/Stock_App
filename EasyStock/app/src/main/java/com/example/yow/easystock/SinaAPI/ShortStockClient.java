...
public class ShortStockClient {
    ...
    private static ShortStockClient mInstance;

    private ShortStockClient(){
    ...
    public synchronized static ShortStockClient getInstance() {

        if(mInstance != null) {
            return mInstance;
        }
        return new ShortStockClient();
    }

    public List<ShortStockInfo> getStockInfo(String[] stockCodes) throws HttpException, IOException, ParseStockInfoException{
        ...
        List<ShortStockInfo> list = parseSinaStockInfosFromReader(bReader);
        bReader.close();
        method.releaseConnection();
    ...
    private List<ShortStockInfo> parseSinaStockInfosFromReader(BufferedReader reader) throws IOException, ParseStockInfoException {

        ArrayList<ShortStockInfo> list = new ArrayList<ShortStockInfo>(10);
        String sourceLine = null;

        while((sourceLine = reader.readLine()) != null) {
            list.add(ShortStockInfo.parseStockInfo(sourceLine));
            //	break;
        }
